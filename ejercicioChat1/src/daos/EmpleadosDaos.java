...
public class EmpleadosDaos {
	...
	public EmpleadosDaos getInstance() throws SQLException {
		if(instance == null) {
	...
	public void insert(Empleado e) throws SQLException {
		...
		PreparedStatement ps = con.prepareStatement("insert into (id_empleado, dni, nombre, puesto, salario, id_proyecto)"
				+ " values(?,?,?,?,?,?)");
